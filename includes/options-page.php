	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
                ...
                <tr valign="top" style="border-top:#dddddd 1px solid;">
					<th scope="row"><?php _e('Work Only Home','wmfrt2d');?></th>
					<td>
                    ...
                    <span style="color:#666666;margin-left:2px;"><?php echo _e('If enable this option script will work only home & front page.','wmfrt2d');?></span>
					</td>
				</tr>
			</table>
			<p class="submit">
